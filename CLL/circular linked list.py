...
class CLL:
    ...
    def InsertionAtend(self):
        print("Insertion At the End of the list:")
    ...
    def InsertionAtMiddle(self):
        print("Insertion At the Middle of the list:")
        data = int(input("Enter the data value: "))
        newnode = Node(data)
    ...
    def DeletionAtbegin(self):
        print("Deletion At the Beginning of the list:")
        self.temp = self.head
    ...
    def DeletionAtend(self):
        print("Deletion At the End of the list:")
        self.temp = self.head
        while self.temp is not self.tail:
            prev = self.temp
            self.temp = self.temp.next
    ...
    def DeletionAtMiddle(self):
        print("Deletion At the Middle of the list:")
